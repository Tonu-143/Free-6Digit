...
psb('\x1b[1;32mJXS 11 DIGIT CLONING STARTED PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : BD-TERMUX 

    print 'FACEBOOK : MEHEDI HASAN TONU

    print 'GITHUB     : TONU-143
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[TONU-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[TONU-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
